...
def handle_dumb_user_registration(cap, window_name, window_width, window_height, last_known_user=None, last_reminder_time=None):
    ...
    if last_known_user is None:
        ...
        greeting_variations = [
            ...
            f"Well hello, {name}! I was hoping that you stop by.",
            f"Nice to see you, {name}.  Ready for another great day?",
            f"{name}, you are back! I am always happy when you are around.",
            ...
            f"Hi again, {name}. I am still here—and always happy to see you!"
        ]
    ...
    reminder_phrases = [
        ...
        f"Medication time is {reminder_time}. I am here whenever you need me. Wave or move again if you need anything",
        f"You guessed it another reminder for your meds at {reminder_time}. Just move again and I will be right here.",
        f"Just doing my job, your meds are due at {reminder_time}. Give me a wave if you would like another reminder.",
